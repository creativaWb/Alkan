        ...
        jToggleButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
               ...
               // jButton3ActionPerformed(evt);
                ...
                {
                	try { 
                		JOptionPane.showMessageDialog(null,"  "+jTextField1.getText()+  " ist als Hauptgruppe in  der Datenbank eingef√ºgt!");
                		 ownderby.openCon();
               ...
               // jButton3ActionPerformed(evt);
                if(evt.getActionCommand()==jToggleButton2.getText())
                {
                	try { 
                		...
                		JOptionPane.showMessageDialog(null,"  "+selected_item+  " ist als Hauptgruppe in  der Datenbank eingef¸gt!");
                		 ownderby.openCon();
