 ...
 * @author Nail
 */
public class offeneKonten extends javax.swing.JFrame {
    /**
    ...
    private void initComponents() {
        ...
        table_offeneKonten = new javax.swing.JTable();
        ...
        table_offeneKonten.setRowHeight(31);
        table_offeneKonten.setShowGrid(false);
        table_offeneKonten.setShowVerticalLines(true);
        jScrollPane1.setViewportView(table_offeneKonten);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        jLabel2.setText("Offene Konten");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(offeneKonten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
